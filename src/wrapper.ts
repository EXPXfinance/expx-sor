...
export class SOR {
    ...
    */
    async setCostOutputToken(
        ...
        if (Cost !== null) {
            this.tokenCost[tokenOutLower] = Cost;
            return;
        }

        // This calculates the cost to make a swap which is used as an input
        // to SOR to allow it to make gas efficient recommendations
        ...
        this.tokenCost[tokenOutLower] = costOutputToken;
    }
    ...
    /*
    Uses pools info contact to fetch all onchain balances for pools.
    */
